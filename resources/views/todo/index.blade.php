                        ...
                        <tbody>
                            @forelse ($todos as $data)
                                <tr
                                    ...
                                    <td scope="row" class="px-6 py-4 font-medium text-gray-200">
                                    ...
                                    <td class="px-6 py-4">
                                        ...
                                        <a href="{{ route('todo.edit', $data) }}"
                                            class="text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-500 text-xs font-semibold">
                                            Edit
                                        </a>
                                    </td>
                                </tr>
